...
public class MainActivity extends AppCompatActivity
  ...
  //AutoComplete Google Sample Start
    ...
    //private TextView mPickupText,mDropOffText;
   ...
   /* public void stopUpdatesButtonHandler(View view) {
    ...
    private void updateLocationUI() {
        ...
        if (mCurrentLocation != null) {
           ...
           mPickupText.setText(CurrentLATLNG.toString());
            ...
            CameraUpdate mCameraCL= CameraUpdateFactory.newLatLngZoom(CurrentLATLNG,18);
            mMap.moveCamera(mCameraCL);
            mMap.animateCamera(mCameraCL);
            mNow=mMap.addMarker(new MarkerOptions().position(CurrentLATLNG)
                    .title(mPickupText.getText().toString()).draggable(true));
